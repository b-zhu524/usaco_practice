# def next_idx(current_idx, direction):
...
def solve(phrases):
    ...
    for phrase in phrases:
        ...
        distance = count_years(cow_zodiacs[compare_name], zodiac, direction, zodiacs, zodiac_indices)
        years_from_bessie[name] = years_from_bessie[compare_name] + distance
        if name == "Elsie":
